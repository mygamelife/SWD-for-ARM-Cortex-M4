...
typedef struct
{
    ...
    __IO uint32_t IMPLEMENTATION[8];    /*!< Offset: 0x1C0 (R/W) Implementation specific registers                    */
    __IO uint32_t ETMSYNCFR;            /*!< Offset: 0x1E0 (R/W) Synchronization Frequency Register                   */
    __I  uint32_t ETMID;R               /*!< Offset: 0x1E4 (R/ ) ID Register*/
...
#define ETM       ((ETM_Type *)   TM_BASE)  /*!< ETM configuration struct    */
