...
void test_isCoreModeRequiresHaltedAndDebug_given_CORE_SNSWD_APSTALL_should_return_0()
{
...
{ 
  cswDataSize = CSW_WORD_SIZE ;
	...
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0xA05F0000);
...
void test_setCoreMode_CORE_NORMAL_MASKINT_will_setCoreMode_to_CORE_DEBUG_HALT_first_and_write_0xA05F0008_to_DHCSR()
{
	...
	emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DHCSR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0xA05F0008);
...
void test_setCoreMode_CORE_SINGLE_STEP_will_setCoreMode_to_CORE_DEBUG_HALT_first_and_write_0xA05F0005_to_DHCSR()
{
	...
	emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DHCSR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0xA05F0005);
...
void test_setCoreMode_SET_CORE_STEP_MASKINT_will_setCoreMode_to_CORE_DEBUG_HALT_first_and_write_0xA05F000D_to_DHCSR()
{
	...
	//Then only set to CORE_SINGLE_STEP
	emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DHCSR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0xA05F000D);
...
{
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DHCSR_REG);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,0x1234);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,0,0);
...
void test_getCoreMode_given_0x8_should_return_CORE_NORMAL_MASKINT()
{
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DHCSR_REG);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,0x1234);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,interconvertMSBandLSB(0x8));
...
void test_getCoreMode_given_0x1_should_return_CORE_DEBUG_MODE()
{
   emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DHCSR_REG);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,0x1234);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,interconvertMSBandLSB(0x1));
...
void test_getCoreMode_given_0x20003_should_return_CORE_DEBUG_HALT_MODE()
{
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DHCSR_REG);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,0x1234);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,interconvertMSBandLSB(0x20003));
...
void test_writeCoreRegister_given_0x52_CORE_REG_R1_should_write_0x52_to_DCRDR_and_0x10001_to_DCRSR()
{
  ...
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DCRDR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0x52);
  
  //Select CORE_REG_R1 and write mode in DCRSR_REG
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DCRSR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0x10001);
  
  //wait for transaction to complete
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DHCSR_REG);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,0x1234);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,interconvertMSBandLSB(0x10000));
...
void test_writeCoreRegister_given_0xFFFFFFFF_CORE_REG_FPREGS31_should_write_0xFFFFFFFF_to_DCRDR_and_0x1005F_to_DCRSR()
{
  ...
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DCRSR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0x1005F);
...
void test_readCoreRegister_given_CORE_REG_PC_should_write_0xF_to_DCRSR_and_read_data_from_DCRDR()
{
  ...
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DCRSR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,CORE_REG_PC);
  ...
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DCRDR_REG);
	emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,0x1234);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,interconvertMSBandLSB(0x1234567));
...
{
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DFSR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0x10);
...
{
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DFSR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0x8);
...
{
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DFSR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0x4);
...
{
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DFSR_REG);
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0x2);
...
void test_enableVectorCatchHARDERR_should_writeHalfWord_0x400_to_DEMCR()
{
  ...
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DEMCR_REG);
  emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0x400);
...
void test_enableVectorCatchCoreReset_should_writeHalfWord_0x1_to_DEMCR()
{
  ...
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DEMCR_REG);
  emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0x1);
...
void test_softResetTarget_should_write_REQUEST_SYTEM_RESET_to_AIRCR_REG()
{
  ...
  emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,REQUEST_SYSTEM_RESET);
  softResetTarget();
}
...
void test_enableDWTandITM_should_writeByte_0xE000EDFF_to_TAR_and_write_1000000_to_DRW()
{
  ...
  emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0x1000000);
