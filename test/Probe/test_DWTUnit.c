...
void test_setDataWatchpoint_MatchingTwoComparator()
{
  ...
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,(uint32_t)(&DWT_COMP[2].COMP));
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0xBEEEEEEF);
  ...
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,(uint32_t)(&DWT_COMP[3].COMP));
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,0xA55AA55A);
  
  //Program 2nd matching mask 
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,(uint32_t)(&DWT_COMP[3].MASK));
	emulateSwdRegisterWrite(DRW_REG,SWD_AP,4,WATCHPOINT_MASK_NOTHING);
...
void test_hasDataWatchpointOccurred_given_DWTTRAP_DEBUGEVENT_1_MATCHED_should_return_1()
{
  ...
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,interconvertMSBandLSB(0x4));
  
  //read DWT_FUNC1 and MATCHED bit set
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,(uint32_t)(&DWT_COMP[1].FUNCTION));
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,0x1234);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,interconvertMSBandLSB(0x1000000));
...
void test_hasDataWatchpointOccurred_given_DWTTRAP_DEBUGEVENT_1_NOT_MATCHED_should_return_0()
{
  ...
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,(uint32_t)(&DWT_COMP[1].FUNCTION));
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,0x1234);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,0,interconvertMSBandLSB(0xA));
...
void test_hasDataWatchpointOccurred_given_DWTTRAP_DEBUGEVENT_0_should_return_0()
{
  ...
  emulateSwdRegisterWrite(TAR_REG,SWD_AP,4,DFSR_REG);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,0x1234);
  emulateSwdRegisterRead(DRW_REG,SWD_AP,4,1,interconvertMSBandLSB(0x0));
