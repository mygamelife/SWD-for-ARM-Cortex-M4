...
void test_writeRamInChunk_should_write_data_according_to_the_size_to_specified_RAM_address(void)
{ 
  uint32_t buffer[] = {0xDEADBEEF, 0x12345678};
  
  memoryWriteByte_ExpectAndReturn(0x20000000, 0xEF, NO_ERROR);
  memoryWriteByte_ExpectAndReturn(0x20000001, 0xBE, NO_ERROR);
  memoryWriteByte_ExpectAndReturn(0x20000002, 0xAD, NO_ERROR);
  memoryWriteByte_ExpectAndReturn(0x20000003, 0xDE, NO_ERROR);
  
  memoryWriteByte_ExpectAndReturn(0x20000004, 0x78, NO_ERROR);
  memoryWriteByte_ExpectAndReturn(0x20000005, 0x56, NO_ERROR);
  memoryWriteByte_ExpectAndReturn(0x20000006, 0x34, NO_ERROR);
  memoryWriteByte_ExpectAndReturn(0x20000007, 0x12, NO_ERROR);
  
  writeRamInChunk((uint8_t *)buffer, 0x20000000, 8);
}
...
// void test_writeTargetFlashInChunk_should_write_into_target_ram_first_then_change_state(void)
// {
  // uartInit_Ignore();
  // Tlv_Session *session = tlvCreateSession();
  ...
  // writeTargetFlashInChunk(session, dataAddress, 0x08001000, 16);
...
// void test_writeTargetFlashInChunk_should_copy_from_sram_to_flash_by_sending_request_copy(void)
// {
  // uartInit_Ignore();
  // Tlv_Session *session = tlvCreateSession();
...
// void test_writeTargetFlashInChunk_should_copy_data_into_sram_and_request_stub_copy(void)
// {
  // uartInit_Ignore();
  // Tlv_Session *session = tlvCreateSession();
...
// void test_probeTaskManager_given_flash_command_should_run_writeTargetFlashInChunk(void)
// {
  // uartInit_Ignore();
  // Tlv_Session *session = tlvCreateSession();
  // uint32_t readData = 0;
