...
void test_isSelectedAddressContains32bitsInstructionExtendedExtended_given_0xE800_should_return_1()
{
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x10000000);
...
void test_isSelectedAddressContainsCallingSubroutineInstruction_given_0xF000D000_should_return_1()
{
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x10000000);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xF000D000));
...
{  
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x10000000);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xF700D000));
...
void test_isSelectedAddressContainsCallingSubroutineInstruction_given_0xF000F000_should_return_1()
{
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x10000000);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xF000F000));  
...
void test_isSelectedAddressContainsCallingSubroutineInstruction_given_0xF0000000_should_return_0()
{
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x10000000);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xF0000000));
...
void test_isSelectedAddressContainsCallingSubroutineInstruction_given_0xF800D000_should_return_0()
{
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x10000000);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xF800D000));
...
void test_isSelectedAddressContainsCallingSubroutineInstruction_given_0xFF00D000_should_return_0()
{
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x10000000);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xFF00D000));
...
{ 
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x10000000);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xE000D000));
...
void test_stepOver_should_do_stepInto_for_16bit_Instruction_and_return_PC()
{
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x22334450);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0x1000));
...
void test_stepOver_should_do_stepInto_for_32bit_normal_Instruction_and_return_PC()
{
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x22334450);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xF8000000));
...
void test_stepOver_should_stepOver_by_setting_breakpoint_when_branch_is_met_and_return_PC()
{
  ...
  emulateSwdRegisterWrite(TAR_REG,AP,4,DFSR_REG);
	emulateSwdRegisterWrite(DRW_REG,AP,4,BKPT_DEBUGEVENT);
...
void test_stepOut_given_inside_Subroutine_should_searchforReturnsubroutineInstruction_stepOnce_and_return_PC()
{
  ...
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x11223330);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xFF00));
  
  //Selected addresss contains 32bit machine code ,next call pc = pc + 4
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x11223334);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xFF00));
  
  
  //Selected addresss contains 16bit machine code but didnt match any return from subroutine instruction , next call pc = pc + 2
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x11223338);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xBD00));
  
  //Selected addresss contains 32bit machine code ,next call pc = pc + 4
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x1122333A);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xFF00));

  //Selected addresss contains 16bit machine code and matches return from subroutine instruction
  emulateSwdRegisterWrite(TAR_REG, AP, OK, 0x1122333E);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, 0);
	emulateSwdRegisterRead(DRW_REG, AP, OK, 1, interconvertMSBandLSB(0xBD80));
